...
module ui.gui {
    export class GameSceneUI extends Laya.View {
        public static  uiView:any ={"type":"View","props":{"width":750,"height":1334},"compId":1,"child":[{"type":"Panel","props":{"top":0,"right":0,"left":0,"bottom":0},"compId":3},{"type":"Image","props":{"y":659,"x":344.5,"skin":"whale/whale.png"},"compId":6}],"loadList":["whale/whale.png"],"loadList3D":[]};
        constructor(){ super()}
        createChildren():void {
